...
To Train: python3 sokoban.py [location of game map input] [location of model (pth file)]* <br/>

To play: python3 sokoban.py [location of game map input] [location of model (pth file)] play
<br/>
"*" = optional
<br/>

Note: Generated model file is called latest.pth in models directory. Rename if you want to keep it/prevent overwriting!
LOOK AT FINAL REPORT FOR THIS INFORMATION, EVERYTHING BELOW IS OUTDATED (INTRO MIGHT BE OUTDATED TOO)
### Training Diagram
